...
if __name__ == "__main__":
    ...
    model = KNNRecommender(X, item_idx=df.item_id.cat.categories, neighbors=args.neighbors)
    
    df.item_id.cat.categories
    fits = []
    val_logs = []
    train_time=0
    if args.validation:
